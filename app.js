    ...
    .then((data) => {
      ...
      for (var i = 0; i < length; i++) {
        if (data[i].country == "Bangladesh")
          html +=
          '<div class="col s12 m4 l3"> <div class="card"> <div class="card-content white-text grey darken-1"><img  class="center-align" src="'+ data[i].countryInfo.flag+'" alt=""><span class="card-title truncate">' + data[i].country +
